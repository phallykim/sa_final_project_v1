...
Route::controller(BDashboardController::class)->group(function () {
    Route::get("/major", [\App\Http\Controllers\backend\BMajorController::class, "index"])->name("major");
});

route::resource('/major',\App\Http\Controllers\backend\BMajorController::class);