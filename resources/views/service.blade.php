                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-services service-style-one">
                        <div class="services-inner  with-shadow card-bg-color">
                            <div class="thumbnail">
                                <img src="{{ asset('assets/images/services/services-icon-01.png') }}" alt="Business consulting services">
                            </div>
                            <div class="services-content">
                                <a href="{{ route('service-details') }}">
                                    <h5 class="title">Request Tracking </h5>
                                </a>
                                <p class="desctiption">
                                Automates request handling from submission to resolution..
                                </p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-services service-style-one">
                        <div class="services-inner  with-shadow card-bg-color">
                            ...
                            <div class="services-content">
                                <a href="{{ route('service-details') }}">
                                    <h5 class="title">User & Access Management</h5>
                                </a>
                                <p class="desctiption">
                                Manages user roles and permissions for secure access.
                                </p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-services service-style-one">
                        <div class="services-inner  with-shadow card-bg-color">
                            ...
                            <div class="services-content">
                                <a href="{{ route('service-details') }}">
                                    <h5 class="title">Reporting & Analytics

                                </h5>
                                </a>
                                <p class="desctiption">
                                Generates reports on request trends and response times.
                                </p>
                    ...
                    <div class="single-work style-one mt--15">
                        <a href="#">
                            <div class="work-inner">
                                ...
                                <p class="description">
                                thank you for meeting with me today. I understand you’re looking for a more efficient way to manage requests within your organization. 
                                </p>
                            </div>
                        </a>
