            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about-inner">
                        ...
                        <p class="description">
                        we provide expert business consulting services designed to help organizations improve efficiency, optimize operations, and drive growth. Our team specializes in identifying challenges, developing strategic solutions, and implementing best practices to enhance business performance.                        </p>
                        <!-- Prograss bar Start  -->
                        ...
                        <div class="single-progress-area progress-stye-one">
                            <div class="progress-top">
                                <p class="name">Request Consulting</p>
                                <span class="parcent">
                                66%
                            </span>
                            </div>
